...
goal_name = input("Enter one skill you want to get better")
...
print (person_name, "will practise", goal_name, "for", daily_minutes, "minutes every day until", target_month + ".")
